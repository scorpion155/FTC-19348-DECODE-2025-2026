...
@Autonomous(name = "🔵 BLUE-AUTO (RED SHOOT)", group = "Autonomous")
@Configurable
public class REDteleop extends OpMode {
    ...
    // BLUE FIELD PATHS (copied from your blue example)
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Path1 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(59.000, 15.000), new Pose(50.000, 31.000)))
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                    .build();

            Path2 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(50.000, 31.000), new Pose(28.000, 31.000)))
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                    .build();
            ...
            Path4 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(58.000, 26.000), new Pose(47.000, 47.000)))
                    .setLinearHeadingInterpolation(Math.toRadians(110), Math.toRadians(180))
                    .build();

            Path5 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(47.000, 47.000), new Pose(28.000, 47.000)))
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                    .build();
            ...
            Path8 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(28.000, 67.000), new Pose(47.000, 67.000)))
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                    .build();

            Path9 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(47.000, 67.000), new Pose(47.000, 67.000)))
    ...
    // SAME AS RED: Limelight distance -> RPM + servo position
        ...
        switch (pathState) {
            ...
            case PATH_1:
                if (!initAimComplete) {
                    ...
                    // Mirror of Red's +99 -> -99 (same magnitude)
                    aimTargetTicks = -99;
            ...
            case PATH_6:
                if (!follower.isBusy()) {
                    ...
                    // SAME AS RED (fixed 300 mode)
                    setShooterVelocity(1000);
                    useFixedShooterVelocity = true;

                    follower.setMaxPower(1);

                    // Mirror of Red aim(70) -> aim(-70)
                    aim(-70);
                }
                break;
            ...
            case PATH_7:
                if (!follower.isBusy()) {
                    ...
                    if (path3Timer.seconds() >= PATH3_DELAY_SECONDS) {
                        ...
                        // SAME AS RED: go back to Limelight-based RPM
    ...
    public void init() {
        try {
            ...
            telemetry.addLine("✅ 🔵 BLUE AUTO (RED SHOOT SETTINGS)");
            ...
            telemetry.addLine("🔧 PATH_6: FIXED 300 RPM");
            telemetry.addLine("═══════════════════════════════");
            telemetry.update();
