...
@Disabled
@Autonomous(name = "🔴 RED-FIX-0 ", group = "Autonomous")
@Configurable
public class REDauto extends OpMode {
    ...
    private static final double RPM_MIN = 0;   // Close shots
        ...
        switch (pathState) {
            ...
            case PATH_3:
                if (!follower.isBusy()) {
                    ...
                    resetBallState();
                    intake(0);
                    setShooterVelocity(1400);  // mid RPM, still distance-refined
