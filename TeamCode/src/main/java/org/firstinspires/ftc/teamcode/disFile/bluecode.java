...
public class bluecode extends LinearOpMode {
...
//    private boolean ballDetected = false;
    ...
    private static final double SERVO_MAX = 0.65;  // maximum angle
    private static final double DIST_MIN  = 0.4;  // meters (close)
    private static final double DIST_MAX  = 3.0;  // meters (far)

    private static final double shooter_MIN = 0.6;  // minimum angle
