...
@Autonomous(name = "PedroPathing 3 ball", group = "Autonomous")
@Configurable
public class path1 extends OpMode {
...
//    private boolean ballDetected = false;
    private final double[] INTAKE_POS = {0.00, 0.32, 0.49}; //{0.22, 0.40, 0.58}; //
    ...
    public static class Paths {
        ...
        public Paths(Follower follower,PathConstraints slow) {
            ...
            Path1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(59.000, 15.000), new Pose(55.000, 31.000))
                    )
            ...
            Path2 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(55.000, 31.000), new Pose(28.000, 31.000))
                    )
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                    .build();
