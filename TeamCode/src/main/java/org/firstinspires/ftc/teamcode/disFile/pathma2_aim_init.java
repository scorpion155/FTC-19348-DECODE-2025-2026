...
@Autonomous(name = "🔵 BLUE-last ", group = "Autonomous")
@Configurable
public class pathma2_aim_init extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Path4 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(58.000, 26.000), new Pose(47.000, 47.000))
                    )
            ...
            Path5 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(47.000, 47.000), new Pose(28.000, 47.000))
                    )
                    .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                    .build();
    ...
    public void updateStateMachine() {
        switch (pathState) {
            ...
            case PATH_1:
                // Initialize aim motor to 85 ticks in PATH_1
                if (!initAimComplete) {
                    aimMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                    aimTargetTicks =-99;  // Hardcoded 85 ticks
    ...
    public void init() {
        try {
            ...
            telemetry.addLine("⚙️ Ready to start");
            telemetry.update();
