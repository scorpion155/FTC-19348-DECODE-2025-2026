 ...
 * Faster aiming version
 */
@TeleOp(name="Stage3_LimelightAiming_Fast", group="Pro")
public class testaim extends LinearOpMode {

    private DcMotor aimMotor;
    private LimelightI2C limelight;

    // PID constants (faster tuning)
    ...
    private final double MAX_POWER = 0.9; // faster movement
    ...
    /**
     * Simple Limelight I2C helper class
